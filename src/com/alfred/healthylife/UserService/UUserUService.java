...
public class UUserUService extends UService {

    public UserDAO userDAO;
    public UserLogDAO userLogDAO;

    public UUserUService() {
        userDAO = new UserDAO();
    ...
    public String create(String email, String password, String confirm_password, long creator, String register_time) {
        ...
        if (id_new != 0) {
            ...
            String str = Util.readImage("default_icon", "/usr/local/HealthyLife/UserIcon/", "png");
            Util.writeImage(str, String.valueOf(id_new), "/usr/local/HealthyLife/UserIcon/", "png");
            return SUCCESS;
        }
        return FAIL;
    ...
    public HashMap<String, Object> loginCheck(String email, String password, String ip_address, String login_time) {
        ...
        long admin_id = 0;
        if (user_info.size() != 0) {
            admin_id = Util.getLongFromMapList(user_info, "id");
        }
    ...
    public String updateIcon(long id, String icon, String create_time, long creator, int creator_type) {
        if (icon.equalsIgnoreCase("")) {
            return FAIL;
        }
        Util.writeImage(icon, String.valueOf(creator), "/usr/local/HealthyLife/UserIcon/", "png");
        userLogDAO.modifyLogo(id, create_time, id, creator_type);
        return SUCCESS;
    }
     ...
     * @return
     */
    public String updatePassword(long id, String new_password, String confirm_password, String create_time, long creator) {
     ...
     * @return
     */
    public String queryWithIcon(long user_id) {
        ArrayList<HashMap<String, Object>> list = new ArrayList<>();
        list = userDAO.queryUserById(user_id);
        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap = list.get(0);
        String icon = Util.readImage(String.valueOf(user_id), "/usr/local/HealthyLife/UserIcon/", "png");
