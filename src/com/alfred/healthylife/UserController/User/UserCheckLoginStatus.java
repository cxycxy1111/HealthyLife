...
@WebServlet(name = "UserCheckLoginStatus", urlPatterns = "/user/checkLoginStatus")
public class UserCheckLoginStatus extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(uUserService.query(current_user));
    }
