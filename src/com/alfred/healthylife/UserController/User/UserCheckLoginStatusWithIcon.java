...
@WebServlet(name = "UserCheckLoginStatusWithIcon", urlPatterns = "/user/checkLoginStatusWithIcon")
public class UserCheckLoginStatusWithIcon extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        UUserUService uUserService = new UUserUService();
        out.append(uUserService.queryWithIcon(current_user));
    }
