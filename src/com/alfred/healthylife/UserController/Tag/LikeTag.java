...
@WebServlet(name = "LikeTag", urlPatterns = "/user/tag/like")
public class LikeTag extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(uUserTagRelService.addFavorite(current_user, id, Util.getCurrentTime()));
    }
