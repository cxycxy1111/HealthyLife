...
@WebServlet(name = "QueryIfLikeTag", urlPatterns = "/user/tag/queryIfLike")
public class QueryIfLikeTag extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(uUserTagRelService.queryIfLike(current_user, tag_id, 0));
    }
