package com.alfred.healthylife.UserController.Question;

import com.alfred.healthylife.UserController.BaseServlet;
import com.alfred.healthylife.UserService.UQuestionUService;
...
public class ProposeQuetion extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        UQuestionUService uQuestionService = new UQuestionUService();
