...
@WebServlet(name = "QueryTipsByKeywords",urlPatterns = "/tip/query/keyword")
public class QueryTipsByKeywords extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(tipService.query(keywords));
    }
