...
@WebServlet(name = "UnlikeTag", urlPatterns = "/user/tag/unlike")
public class UnlikeTag extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(uUserTagRelService.removeFavorite(current_user, id, Util.getCurrentTime()));
    }
